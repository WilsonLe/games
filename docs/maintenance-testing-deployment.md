...
| Test | Expected |
| --- | --- |
| Initial load | One guest enters; score 0, orders 0/24, level 1, and six kitchen-pass slots are visible. The first seated guest shows the visible guided helper and cannot expire before the first correct serve. |
