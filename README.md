---
description: "Public project overview, setup, and documentation map for Table Talk Games."
references: []
---

# Table Talk Games

Table Talk Games is a React/Vite game portal with:

- **Table Talk Diner**, a 2D food-serving arcade game for practicing practical English orders.
- **Tiny City Delivery**, a map-routing simulator where children use English prepositions, place
  words, and quantities to complete deliveries.

The app is client-only: React state, CSS animation, image assets, browser speech synthesis, and
browser Web Audio sound effects. There is no backend, persistence layer, or automated test suite in
this repo today.
...
| [Hunter Workflow](./docs/hunter/hunter-workflow.md) | Future-session workflow, process records, todos, and graph validation. |

## Repo Shape

```text
src/App.tsx              Game data, components, routing, state, timers, audio, and scoring
src/styles.css           Full app styling, scene layers, animations, maps, tables, and breakpoints
